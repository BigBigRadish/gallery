            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="<%=basePath %>favourite/add.jhtml" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新建收藏夹
                        </a>
                    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <!-- row -->
                       	<c:forEach items="${list }" var="var">
	                        <tr class="first">
	                            <td>
	                            	<a href="http://${var.url }" target="_blank">${var.url }</a>
	                            </td>
	                            <td>
	                               ${var.memo }
	                            </td>
	                            ...
	                            <td class="align-right">
	                                <a href="<%=basePath %>favourite/add.jhtml?id=${var.id}">更新</a>
	                                <a href="<%=basePath %>favourite/delete.jhtml?id=${var.id}">删除</a>
	                            </td>
	                        </tr>
                        </c:forEach>
                        </tbody>
