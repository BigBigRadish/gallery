        ...
        <ul id="dashboard-menu">
            ...
            <li >
                ...
                <ul class="active submenu">
                    ...
                    <li><a href="<%=basePath %>favourite/add.jhtml" class="active">新建收藏</a></li>
                </ul>
            </li>
            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" id="form" action="<%=basePath %>favourite/save.jhtml" method="post"/>
                            	<input type="hidden" value="${entity.id }" name="id"/>
                                <div class="span12 field-box">
                                    <label>URL:</label>
                                    <input class="span9" type="text" name="url" id="url" value="${entity.url }"/>
                                </div>
                                <div class="span12 field-box">
                                    <label>备注:</label>
                                    <textarea class="span9" name="memo" id="memo">${entity.memo }</textarea>
