        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="active submenu">
                    <li><a href="<%=basePath %>contacts/list.jhtml" class="active">联系人列表</a></li>
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <a href="<%=basePath %>contacts/updatePage.jhtml" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            新建联系人
                        </a>
                    </div>
                       	...
                       	<c:forEach items="${list }" var="var">
	                        <tr class="first">
	                            ...
	                            <td class="align-right">
	                                <a href="<%=basePath %>contacts/updatePage.jhtml?id=${var.id}">更新</a>
	                                <a href="<%=basePath %>contacts/delete.jhtml?id=${var.id}">删除</a>
	                            </td>
	                        </tr>
                        </c:forEach>
                        </tbody>
