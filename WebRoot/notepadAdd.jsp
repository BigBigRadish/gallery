        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="submenu">
                   ...
                   <li><a href="<%=basePath %>contactsAdd.jsp" >新建联系人</a></li>
              ...
              <li >
                ...
                <ul class="active submenu">
                    ...
                    <li><a href="<%=basePath %>notepad/add.jhtml" class="active">新建记事本</a></li>
                </ul>
            </li>
            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" id="form" action="<%=basePath %>notepad/save.jhtml" method="post"/>
                            	<input type="hidden" value="${entity.id }" name="id"/>
                                <div class="span12 field-box">
                                    <label>标题:</label>
                                    <input class="span9" type="text" name="title" id="title" value="${entity.title }"/>
                                </div>
                                <div class="span12 field-box">
                                    <label>内容:</label>
                                    <textarea class="span9" name="content" id="content">${entity.content }</textarea>
